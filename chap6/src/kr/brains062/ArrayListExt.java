...
// 같은 패키지에 존재하는 클래스나 java.lang 패키지에 포함된 클래스는 import 없이 사용가능
...
public class ArrayListExt<T> extends ArrayList<T> {
	...
	public boolean add() {     //중첩 : 이름같고, 매개변수 객수, 타입 다름 (기존 메소드 사용가능)
		super.add((T)"홍길동");
		//System.out.println("자바 프로그래밍");
		return true;
	}
	public int lastIndexOf(Object o) {    // 재정의 : 이름, 갯수, 타입 같음(기존 메소드 사용 불가)
